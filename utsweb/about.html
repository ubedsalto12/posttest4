...
<body>
    <header>
        <div class="logo">
            <img src="gambar3.jpg" alt="logo" class="logo-img" />
    ...
    <div class="container">
        <div class="intro">
            ...
            <p class="description" id="nama">Nama :Muhammad Reza Ubaidillah</p>
            <p class="description" id="nim">NIM : 2109106084</p>
            ...
            <img src="gambar4.jpg" alt="gambar diri" class="profil">
        </div>
    </div>
    <footer>
